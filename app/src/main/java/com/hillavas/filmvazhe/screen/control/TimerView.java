...
public class TimerView extends android.support.v7.widget.AppCompatTextView {
    ...
    public TimerView(Context context) {
        this(context, null, R.style.whiteButtonTheme);
    }

    public TimerView(Context context, AttributeSet attrs) {
        this(context, attrs, R.style.whiteButtonTheme);
    }

    public TimerView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, R.style.whiteButtonTheme);
        mContext = context;
